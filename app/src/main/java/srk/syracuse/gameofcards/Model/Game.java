...
public class Game
{
    ...
    Game(ArrayList<String> usernames, int numberOfDeck, int numberOfCardsDraw, boolean drawEqual, ArrayList<Cards> restrictedCards)
    {
    ...
    public Hand getHand()
    {
        ...
        int deckNum=0;boolean didGive=false;
        for (int i=0;i<this.numberOfCardsDraw;i++)
        {
            didGive=false;
            while(didGive!=true)
            {
                deckNum=randInt(0, numberOfDeck);
